...
| **Prisma**            | `^5.14.0`             | Next-gen ORM (Object-Relational Mapper) | Connects our Next.js app to the PostgreSQL database with end-to-end type safety. Generates a type-safe client for all database queries.                      | Drizzle, TypeORM, Kysely      |
